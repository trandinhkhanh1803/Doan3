...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(holder.pic.getContext()).load("http://192.168.1.66/Crdu_php_pdo/uploads/"+RecommendedDomains.get(position).getPicture()).into(holder.pic);
...
//
//    public RecommendedAdapter(List<Recommended> data) {
//        this.data = data;
//    }
//
//    @NonNull
...
//    @Override
//    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
//        Recommended recommended = data.get(position);
//        holder.title.setText(data.get(position).getTitle());
//        holder.price.setText(data.get(position).getPrice());
//        Glide.with(holder.pic.getContext()).load("http://10.50.119.60/apiFastkaFood/images/"+data.get(position).getPicture()).into(holder.pic);
//
//        holder.itemRec.setOnClickListener(v -> {
//            Intent intent = new Intent(holder.itemView.getContext(), ShowDetailActivity.class);
//            intent.putExtra("dataRec",recommended);
//            holder.itemView.getContext().startActivity(intent);
//        });
//    }
//
